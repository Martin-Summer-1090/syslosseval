...
the paper "Systemic Loss Evaluation" by Thomas Breuer, Martin Summer and Branko Urosevic. You can download the paper at https://ideas.repec.org/p/onb/oenbwp/235.html#download
The code and the data published in this repository support the analysis of this paper.
